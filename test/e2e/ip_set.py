...
"""Utilities for working with IPSet resources"""
...
def wait_until_deleted(
    ...
    """Waits until an IPSet with a supplied Name and ID is no longer returned from
    the WAFv2 API.
    ...
    while True:
        if datetime.datetime.now() >= timeout:
            pytest.fail("Timed out waiting for IPSet to be " "deleted in WAFv2 API")
