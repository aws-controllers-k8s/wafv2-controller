...
type FieldToMatch struct {
	...
	AllQueryArguments []byte `json:"allQueryArguments,omitempty"`
	// Inspect the body of the web request. The body immediately follows the request
	// headers.
	//
	// This is used to indicate the web request component to inspect, in the FieldToMatch
	...
	QueryString []byte `json:"queryString,omitempty"`
	...
	URIPath []byte `json:"uriPath,omitempty"`
}
...
type RateBasedStatementCustomKey struct {
	...
	ForwardedIP []byte `json:"forwardedIP,omitempty"`
	...
	HTTPMethod []byte `json:"httpMethod,omitempty"`
