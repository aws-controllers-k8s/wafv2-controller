...
// +kubebuilder:rbac:groups=wafv2.services.k8s.aws,resources=rulegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wafv2.services.k8s.aws,resources=rulegroups/status,verbs=get;update;patch
