...
const (
	FinalizerString = "finalizers.wafv2.services.k8s.aws/WebACL"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("webacls")
