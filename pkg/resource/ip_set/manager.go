...
// +kubebuilder:rbac:groups=wafv2.services.k8s.aws,resources=ipsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wafv2.services.k8s.aws,resources=ipsets/status,verbs=get;update;patch
