...
const (
	finalizerString = "finalizers.wafv2.services.k8s.aws/IPSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("ipsets")
